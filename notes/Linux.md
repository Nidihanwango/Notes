...
3. 依次安装以下rpm包
   ...
   2. pm -ivh mysql-community-libs-5.7.26-1.el7.x86_64.rpm
   3. pm -ivh mysql-community-client-5.7.26-1.el7.x86_64.rpm
   4. pm -ivh mysql-community-server-5.7.26-1.el7.x86_64.rpm
4. 运行mysql
